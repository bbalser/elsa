defmodule Elsa.ProducerTest do
  ...
  describe "produce_sync" do
    test "stuff" do
      ...
      assert reason == "1341 messages succeeded before elsa producer failed midway through due to :some_reason"
      assert 2000 - 1341 == length(failed)
      assert failed == Enum.drop(messages, 1341)
    end
  end
